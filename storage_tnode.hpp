...
public:
  ...
  */
  ...
  //To Do метод выдать регулярное выражение получается знаем конец строки нужно идти 
  //   к началу до начала хранилища или конца другого регулярного выражение(флаг end)
};
